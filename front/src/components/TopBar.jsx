...
const TopBar = () => {
  return (
    <header className="fixed top-0 right-0 left-64 h-16 flex items-center justify-between px-8 z-30 bg-white/60 backdrop-blur-md border-b border-white/20 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-2 rounded-full font-label-bold text-label-bold shadow-md hover:opacity-90 transition-opacity">
          Launch Campaign
        </button>
        <img 
          alt="User profile" 
